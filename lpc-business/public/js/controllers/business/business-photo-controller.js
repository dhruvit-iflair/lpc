angular.module('inspinia')
    .controller('businessPhotoCtrl', function($scope, $rootScope, $http, $state) {
        ...
        $scope.delete = function(index) {
            ...
            console.log('/deletephoto/' +id + '/' +image)
            $http.get('/deletephoto/' +id + '/' +image)
                .then(function(res) {
                    $scope.photos = res.data
                }, function(err) {
                    console.log(err)
