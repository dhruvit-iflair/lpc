angular.module('inspinia')
    .controller('profileCtrl', function($loader, env_var, $timeout, toastr, $state, $scope, $http, $rootScope) {
        ...
        $scope.editCustomer = function(profileData) {
            if(this.profileForm.$invalid) {
                $scope.submitted = true
            } else {
