angular.module('inspinia')
    ...
    .controller('customerListCtrl', function(DTOptionsBuilder, toastr, $timeout, $scope, $http, $rootScope, $state, $stateParams, $ngConfirm) {
        ...
        $scope.updateStatus = function(index) {
            ...
            $http.get('/customerStatus/' +$scope.customerId)
                .then(function(res) {
                    ...
                    buttons: {
                        sayBoo: {
                            ...
                            action: function(scope,rootScope, button) {
                                $http.delete('/customer/' +$scope.customerId)
                                    .then(function(res) {
